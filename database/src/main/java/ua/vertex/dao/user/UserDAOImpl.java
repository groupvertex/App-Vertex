...
public class UserDAOImpl implements UserDAO {
    ...
    private static final String SELECT_BY_EMAIL = "SELECT * FROM users.register_user WHERE email = :email";
    ...
    public User read(long id) {
        ...
        User user = jdbcTemplate.queryForObject(SELECTSQL, namedParameters, new UserMapper());
        return user;
    }
    ...
    public User read(String email) {
        ...
        User user = jdbcTemplate.queryForObject(SELECT_BY_EMAIL, namedParameters, new UserMapper());
        return user;
    }
